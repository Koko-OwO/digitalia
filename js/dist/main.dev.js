...
window.addEventListener('load', animateIn); // const checkbox = document.getElementById("checkbox");
...
var elementos = document.querySelectorAll(".losque"); // Agregar eventos a cada elemento
...
var elemen = document.querySelectorAll(".btn"); // Agregar eventos a cada elemento
